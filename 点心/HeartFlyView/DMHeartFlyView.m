...
//    [self drawHeartInRect:rect];
    ...
    NSDictionary *dic = @{NSFontAttributeName:[UIFont systemFontOfSize:50.0]};
    
    _arr = [NSArray arrayWithObjects:@"😀",@"😬",@"😁",@"😂",@"😃",@"😄",@"😅",@"😆", @"😇",@"😉",@"😊",@"🙂",@"🙃",@"☺️",@"😋",@"😌",@"😍",@"😘",@"😗",@"😙",@"😚",@"😜",@"😝",@"😛",@"🤑",@"🤓",@"😎",@"🤗",@"😏",@"😶",@"😐",@"😑",@"😒",@"🙄",@"🤔",@"😳",@"😞",@"😟",@"😠",@"😡",@"😔",@"😕",@"🙁",@"☹️",@"😣",@"😖",@"😫",@"😩",@"😤",@"😮",@"😱",@"😨",@"😰",@"😯",@"😦",@"😧",@"😢",@"😥",@"😪",@"😓",@"😭",@"😵",@"😲",@"🤐",@"😷",@"🤒",@"🤕",@"😴",@"💤",@"👻",@"👍",@"✌️",@"💪",@"🙏",@"🖕",@"👀",@"哦",@"💋",@"💍",@"🙈",@"🐷",@"🌴",@"🌿",@"🏃",@"🍃",@"🍂",@"🌾",@"🌻",@"🌸",@"🌚",@"✗",@"✔︎",@"❤︎",@"☆",@"⚉",@"☀︎",@"☁︎",@"♡",@"☺︎",@"☹",@"🇨🇳",@"♥️",@"💯",@"💔",@"💕",@"💜",@"💙",@"🚬",@"💊",@"🍎",@"💥",@"☃️",@"⭐️",@"🔥",@"哈哈",nil];
    
    
    int r = arc4random() % [_arr count];
    
//    NSLog(@"%@",_arr[r]);
    
    [_arr[r] drawInRect:CGRectMake(10, 20, 100, 120) withAttributes:dic];
